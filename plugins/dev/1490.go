...
func init() {
	engine := crawlers.Register("1490", "运输部", "https://www.gov.uk/government/organisations/department-for-transport")

	engine.SetStartingURLs([]string{
		"https://www.gov.uk/search/news-and-communications?organisations[]=department-for-transport&parent=department-for-transport",
	})
