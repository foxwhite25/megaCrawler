...
func init() {
	...
	engine.SetStartingURLs([]string{"https://english.mgimo.ru/news"})
	...
	// })
	// engine.OnHTML(".top-menu > li > a", func(element *colly.HTMLElement, ctx *crawlers.Context) {
	// 	engine.Visit(element.Attr("href"), crawlers.Index)
	// })

	engine.OnHTML(".news-img > a", func(element *colly.HTMLElement, ctx *crawlers.Context) {
		engine.Visit(element.Attr("href"), crawlers.News)
	})
	engine.OnHTML(".col > p", func(element *colly.HTMLElement, ctx *crawlers.Context) {
