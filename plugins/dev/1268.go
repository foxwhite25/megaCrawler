...
func init() {
	engine := crawlers.Register("1268", "罗伊研究中心权力与外交项目", "https://www.lowyinstitute.org")

	engine.SetStartingURLs([]string{"https://www.lowyinstitute.org/publications", "https://www.lowyinstitute.org/people/experts"})
