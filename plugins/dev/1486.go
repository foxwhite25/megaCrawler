...
func init() {
	engine := crawlers.Register("1486", "数码文化传媒及体育部", "https://www.gov.uk/government/organisations/department-for-culture-media-and-sport")

	engine.SetStartingURLs([]string{
		"https://www.gov.uk/search/news-and-communications?organisations[]=department-for-culture-media-and-sport&parent=department-for-culture-media-and-sport",
	})
