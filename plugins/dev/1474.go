...
func init() {
	...
	//采集PDF
	engine.OnHTML(".file.file--mime-application-pdf > a", func(element *colly.HTMLElement, ctx *crawlers.Context) {
	...
	engine.OnHTML(".block-region-content", func(element *colly.HTMLElement, ctx *crawlers.Context) {
