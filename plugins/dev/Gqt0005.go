...
func init() {
	engine := crawlers.Register("05", "REPUBLIC OF THE PHILIPPINES DEPARTMENT OF EDUCATION", "www.deped.gov.ph")
	...
	engine.OnHTML(`[aria-label="Next"]`, func(element *colly.HTMLElement, ctx *crawlers.Context) {
