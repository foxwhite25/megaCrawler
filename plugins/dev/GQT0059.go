...
func init() {
	engine := crawlers.Register("GQT0059", "Philippine Legislators' Committee on Population and Development Foundation,Inc.", "https://www.plcpd.org.ph/category/advocacy-update/")
