...
func init() {
	engine := crawlers.Register("1487", "教育部", "https://www.gov.uk/government/organisations/department-for-education")

	engine.SetStartingURLs([]string{
		"https://www.gov.uk/search/news-and-communications?organisations[]=department-for-education&parent=department-for-education",
	})
