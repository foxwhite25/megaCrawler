...
func init() {
	engine := crawlers.Register("1488", "环境食品及乡郊事务部", "https://www.gov.uk/government/organisations/department-for-environment-food-rural-affairs")

	engine.SetStartingURLs([]string{
		"https://www.gov.uk/search/news-and-communications?organisations[]=department-for-environment-food-rural-affairs&parent=department-for-environment-food-rural-affairs",
	})
