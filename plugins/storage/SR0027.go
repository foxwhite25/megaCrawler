...
func init() {
	engine := crawlers.Register("SR0027", "Northcliff Melville Times", "https://www.citizen.co.za/northcliff-melville-times/")

	engine.SetStartingURLs([]string{"https://www.citizen.co.za/northcliff-melville-times/local/news-headlines/"})
