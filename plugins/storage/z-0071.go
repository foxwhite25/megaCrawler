...
func init() {
	engine := crawlers.Register("z-0071", "Domain Name Wire", "https://domainnamewire.com/")

	engine.SetStartingURLs([]string{"https://domainnamewire.com/"})
	...
	engine.OnHTML("a.more-link", func(element *colly.HTMLElement, ctx *crawlers.Context) {
