...
func init() {
	engine := crawlers.Register("1058", "澳门日报", "https://macaudailytimes.com.mo")

	engine.SetStartingURLs([]string{"https://macaudailytimes.com.mo"})
	...
	// 	engine.Visit(element.Attr("href"), crawlers.Index)
	// })
	engine.OnHTML(".description-container > h1 > a", func(element *colly.HTMLElement, ctx *crawlers.Context) {
	...
	// })
	engine.OnHTML("body > div:nth-child(9) > div.grid-3-4.list-one-col > div.pagination-container > ul > li:nth-child(4) > a", func(element *colly.HTMLElement, ctx *crawlers.Context) {
		engine.Visit(element.Attr("href"), crawlers.Index)
	})
