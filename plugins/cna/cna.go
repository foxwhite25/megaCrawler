...
func init() {
	...
	//报告标题
	w.OnHTML("#main-content > div > div.page-title > h1", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Title = element.Text
	})
	w.OnHTML("#article-header > h1", func(element *colly.HTMLElement, ctx *Crawler.Context) {
		ctx.Title = element.Text
	})
