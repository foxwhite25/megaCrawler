...
func init() {
	engine := crawlers.Register("N-0003", "Mindanao Times (Philippines)", "https://mindanaotimes.com.ph/")

	engine.SetStartingURLs([]string{"https://mindanaotimes.com.ph/sitemap_index.xml"})
